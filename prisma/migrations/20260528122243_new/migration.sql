...
ALTER TABLE "Poule" ALTER COLUMN "phase" TYPE "Phase_new" USING (
  CASE "phase"::text
    WHEN 'GROUP' THEN 'GROUP_STAGE'
    WHEN 'R16'   THEN 'ROUND_OF_16'
    WHEN 'R8'    THEN 'ROUND_OF_32'
    WHEN 'QUARTER' THEN 'QUARTER_FINAL'
    WHEN 'SEMI'  THEN 'SEMI_FINAL'
    ELSE "phase"::text
  END
)::"Phase_new";
ALTER TABLE "Match" ALTER COLUMN "phase" TYPE "Phase_new" USING (
  CASE "phase"::text
    WHEN 'GROUP' THEN 'GROUP_STAGE'
    WHEN 'R16'   THEN 'ROUND_OF_16'
    WHEN 'R8'    THEN 'ROUND_OF_32'
...
ADD COLUMN     "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE "MemberProfile" ALTER COLUMN "updatedAt" DROP DEFAULT;
...
ADD COLUMN     "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
ALTER COLUMN "phase" SET DEFAULT 'GROUP_STAGE';
ALTER TABLE "Poule" ALTER COLUMN "updatedAt" DROP DEFAULT;
...
UPDATE "Registration" SET "gender" = 'PREFER_NOT_TO_SAY' WHERE "gender" IS NULL;
...
ADD COLUMN     "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE "Sponsor" ALTER COLUMN "updatedAt" DROP DEFAULT;
...
ADD COLUMN     "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE "Tiebreaker" ALTER COLUMN "updatedAt" DROP DEFAULT;
